...
if ($InstallerToken.length -lt 32) {$hexString = [System.Convert]::FromBase64String($InstallerToken + "==") 
                                    $InstallerToken = ($hexString|ForEach-Object ToString X2) -join '' }
if (get-service ltservice -erroraction silentlycontinue) {Uninstall-LTService -Server "https://forrestertech.hostedrmm.com" -Force }
Install-LTService -Server "https://forrestertech.hostedrmm.com" -InstallerToken $InstallerToken
pause
